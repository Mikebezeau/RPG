<?php
	...
	if($doUpdate == false) {
		...
		$data['queries'][] = $query = "INSERT INTO QuickStats (QuickStatID, Name, Description, CatagoryID, SizeID, AlignGoodID, AlignChaosID, Initiative, Armor, DeflectAC, Dodge, NaturalAC, DR, SR, HD, HP, ASP, DSP, Fort, Ref, Will, Move, Swim, Fly, Space, Reach, StrMod, DexMod, ConMod, IntMod, WisMod, ChaMod, BAB, CMB, BullRushB, DisarmB, GrappleB, SunderB, TripB, FeintB, CMD, BullRushD, DisarmD, GrappleD, SunderD, TripD, FeintD, SpriteID, ThumbPicID, FullPicID) VALUES (".$quick_stat_id.", '".$charactername."', 'Player character', 0, ".$size_id.", ".$aligngoodid.", ".$alignchaosid.", ".$totalinit.", 0, 0, 0, 0, '".$dr."', ".$sr.", ".$totallevel.", ".$totalhp.", ".$total_asp.", ".$total_dsp.", ".$arr_totalsaveroll[0].", ".$arr_totalsaveroll[1].", ".$arr_totalsaveroll[2].", ".$movementrate.", 0, 0, 5, 5, ".$arr_attmod[0].", ".$arr_attmod[1].", ".$arr_attmod[2].", ".$arr_attmod[3].", ".$arr_attmod[4].", ".$arr_attmod[5].", ".$totalbab.", ".$totalcmb.", ".$bullrush_b.", ".$disarm_b.", ".$grapple_b.", ".$sunder_b.", ".$trip_b.", ".$feint_b.", ".$totalcmd.", ".$bullrush_d.", ".$disarm_d.", ".$grapple_d.", ".$sunder_d.", ".$trip_d.", ".$feint_d.", 0, 0, 0)";
