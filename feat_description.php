...
<div id="container">
  ...
  <div id="maincontent">
    <?php
		...
		$query = 'SELECT * FROM Feats WHERE FeatID = '.$feat_id;
		// Perform Feats Query
		...
		{
			//****************************************
			//DISPLAY FEAT DATA ON SCREEN
			echo '<div class="heading"><p class="alignleft">'.$row->FeatName.'</p><div style="clear: both;"></div></div>';
			echo '<div><h4><p><b>Prerequisites</b> '.$row->Prerequisites.'</p></h4></div>';
			echo '<div><h4><p><b>Description</b> '.$row->Description.'</p></h4></div>';
		} // end while
	?>
  <!-- end #maincontent -->
</div>
